 ...
 *
 * @note If the device was already initialized, users can also use it to get
 * handle.
 * @note This function will be called in `bsp_display_start()` when using LCD
 * sub-board 2 with the resolution of 480x480.
